...
public class ScatterChart extends XYChart {
    ...
    public void drawSeries(Canvas canvas, Paint paint, List<Float> points, SimpleSeriesRenderer seriesRenderer, float yAxisValue, int seriesIndex, int startIndex) {
        ...
        int i;
        float[] path;
        switch (C00861.$SwitchMap$org$achartengine$chart$PointStyle[renderer.getPointStyle().ordinal()]) {
    ...
    public void drawLegendShape(Canvas canvas, SimpleSeriesRenderer renderer, float x, float y, int seriesIndex, Paint paint) {
        ...
        switch (C00861.$SwitchMap$org$achartengine$chart$PointStyle[((XYSeriesRenderer) renderer).getPointStyle().ordinal()]) {
            case Zoom.ZOOM_AXIS_X /*1*/:
