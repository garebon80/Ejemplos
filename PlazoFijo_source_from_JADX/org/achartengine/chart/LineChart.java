...
public class LineChart extends XYChart {
    ...
    static /* synthetic */ class C00851 {
        static final /* synthetic */ int[] f3x6d3783d5;

        static {
            f3x6d3783d5 = new int[Type.values().length];
            try {
                f3x6d3783d5[Type.BOUNDS_ALL.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f3x6d3783d5[Type.BOUNDS_BELOW.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f3x6d3783d5[Type.BOUNDS_ABOVE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f3x6d3783d5[Type.BELOW.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f3x6d3783d5[Type.ABOVE.ordinal()] = 5;
    ...
    public void drawSeries(Canvas canvas, Paint paint, List<Float> points, SimpleSeriesRenderer seriesRenderer, float yAxisValue, int seriesIndex, int startIndex) {
        ...
        for (FillOutsideLine fill : renderer.getFillOutsideLine()) {
            if (fill.getType() != Type.NONE) {
                ...
                switch (C00851.f3x6d3783d5[fill.getType().ordinal()]) {
