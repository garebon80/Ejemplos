...
class SpinnerICS extends AbsSpinnerICS implements OnClickListener {
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        class C01041 implements OnItemClickListener {
            final /* synthetic */ SpinnerICS val$this$0;

            C01041(SpinnerICS spinnerICS) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleRes) {
            ...
            setOnItemClickListener(new OnItemClickListenerWrapper(new C01041(SpinnerICS.this)));
        }
    ...
    SpinnerICS(Context context, int mode) {
        this(context, null, C0051R.attr.spinnerStyle, mode);
    }

    SpinnerICS(Context context, AttributeSet attrs) {
        this(context, attrs, C0051R.attr.spinnerStyle);
    }
    ...
    SpinnerICS(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0051R.styleable.Spinner, defStyle, MODE_DIALOG);
        if (mode == MODE_THEME) {
