...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0051R.styleable.ActionBar, C0051R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(1, 0));
        a.recycle();
        if (this.mSplitWhenNarrow) {
            setSplitActionBar(getContext().getResources().getBoolean(C0051R.bool.abc_split_action_bar_is_narrow));
        }
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility != getVisibility()) {
            Animation anim = AnimationUtils.loadAnimation(getContext(), visibility == 0 ? C0051R.anim.abc_fade_in : C0051R.anim.abc_fade_out);
            startAnimation(anim);
