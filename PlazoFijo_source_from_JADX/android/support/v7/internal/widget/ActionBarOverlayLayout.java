...
public class ActionBarOverlayLayout extends FrameLayout {
    ...
    static {
        mActionBarSizeAttr = new int[]{C0051R.attr.actionBarSize};
    }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = findViewById(C0051R.id.action_bar_activity_content);
            if (this.mContent == null) {
                this.mContent = findViewById(16908290);
            }
            this.mActionBarTop = findViewById(C0051R.id.top_action_bar);
            this.mContainerView = (ActionBarContainer) findViewById(C0051R.id.action_bar_container);
            this.mActionView = (ActionBarView) findViewById(C0051R.id.action_bar);
            this.mActionBarBottom = findViewById(C0051R.id.split_action_bar);
        }
    }
}
