...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    class C00754 implements OnFocusChangeListener {
        C00754() {
        }
    ...
    class C00765 implements OnLayoutChangeListener {
        C00765() {
        }
    ...
    class C00776 implements OnGlobalLayoutListener {
        C00776() {
        }
    ...
    class C00787 implements OnClickListener {
        C00787() {
        }
    ...
    class C00798 implements OnKeyListener {
        C00798() {
        }
    ...
    class C00809 implements OnEditorActionListener {
        C00809() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mShowImeRunnable = new C00721();
        this.mUpdateDrawableStateRunnable = new C00732();
        this.mReleaseCursorRunnable = new C00743();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C00787();
        this.mTextKeyListener = new C00798();
        this.mOnEditorActionListener = new C00809();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0051R.layout.abc_search_view, this, true);
        this.mSearchButton = findViewById(C0051R.id.search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0051R.id.search_src_text);
        ...
        this.mSubmitButton = findViewById(C0051R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0051R.id.search_close_btn);
        this.mVoiceButton = findViewById(C0051R.id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0051R.id.search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C00754());
        TypedArray a = context.obtainStyledAttributes(attrs, C0051R.styleable.SearchView, 0, 0);
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0051R.styleable.View, 0, 0);
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C00765());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C00776());
    }
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(C0051R.attr.searchViewSearchIcon, outValue, true);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0051R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0051R.dimen.abc_dropdownitem_text_padding_left) : 0;
